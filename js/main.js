(function () {
    ...
    var SLIDES = [
        ...
        },
        {
            ...
            caption: "Спускаться в канализацию нужно с осторожностью, они полны тварей, которые сожрут тебя раньше, чем ты успеешь пискнуть"
        },
        {
            image: "images/slide-04-revive.png",
            caption: "Будь бдителен, ведь твой соратник, который как ты думал умер, ещё может быть быстро поднят на ноги"
        }
    ];
